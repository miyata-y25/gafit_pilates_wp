        ...
        <div class="header-cont">
            <nav class="header-nav">
                <ul class="g-nav">
                    ...
                    <li class="g-nav__list"><a href="#link02">マシンピラティススタジオとは</a></li>
                    <li class="g-nav__list"><a href="#link05">インストラクター</a></li>
                    ...
                    <li class="g-nav__list"><a href="<?php echo home_url('/'); ?>#link02">マシンピラティススタジオとは</a></li>
                    <li class="g-nav__list"><a href="<?php echo home_url('/'); ?>#link05">インストラクター</a></li>
